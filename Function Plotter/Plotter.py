...
class Plotter:
    ...
    def splitNumeratorDenominator(self,func):
        ...
        '''
            ...
            Split the function into a numerator and a denominator if the input function in the form of ex :-> x/x+1 to be
            : numFn="x" , denFn="x+1" and the output f(x)= numFn(x)/denFn(x)
        
            Args:
                fund : the input function.
